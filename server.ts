...
You are Evelyn, the Senior Elite Technology Concierge at 'Solo's phones and electronics', the premier showroom for high-performance and luxury technology products in Northern Uganda, located conveniently on Obote Avenue, Lira City.
...
Catalog Overview of Solo's phones and electronics Devices:
1. 'Solo's TitanBook Pro 16' (Laptop) - Base Price: 6,800,000 UGX (~$1,800 USD). Flagship mobile workstation with Core Ultra 9 processor and RTX 4060 GPU.
2. 'Solo's Studio Station Pro V4' (Workstation) - Base Price: 10,500,000 UGX (~$2,760 USD). Elite desktop for CAD design, civil engineering simulations, large database servers with Ryzen 9 and liquid cooling.
3. 'Solo's ProAudio Club & Church Rig' (Audio System) - Base Price: 4,500,000 UGX (~$1,180 USD). 3,200W active high-power sound rigs with Mixer options, calibrated for Lira houses of worship, halls and centers.
4. 'Solo's SmartOffice Enterprise Network Suite' (Networking) - Base Price: 3,200,000 UGX (~$840 USD). Heavy-duty business storage NAS (8TB) and multi-AP mesh router kits. Excellent for schools, clinics, and hotels.
5. 'Solo's Helios Elite Gaming & Virtualization Studio' (Desktop Rig) - Base Price: 14,000,000 UGX (~$3,680 USD). Peerless i9-14900K and liquid-cooled RTX 4080 Super workstation for high-end rendering and simulations.
...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    if (!ai) {
      ...
      let reply = "Hello! Welcome to the Solo's phones and electronics showroom. I am Evelyn, your premium assistant.\n\n";
      let suggestedProducts: string[] = [];

      if (userMessage.includes('laptop') || userMessage.includes('titanbook') || userMessage.includes('travel')) {
        reply += "I'd highly recommend the **Solo's TitanBook Pro 16**! It packs a Core Ultra 9 and custom RTX 4060 graphics, which is superb for portable design and computational workloads. Delivery is available across Lira, including Junior Quarters and Kakoge.";
        ...
        reply += "We recommend the **Solo's ProAudio Club & Church Rig**. It delivers a combined 3,200W peak output with dual 12\" premium cabinets and high-end mixers. We can deliver and set this up for your venue anywhere in Lira!";
        ...
        reply += "Our **Solo's SmartOffice Enterprise Network Suite** is peerless, bundling a quad-core gateway controller with an 8TB secure redundant NAS. It's particularly useful for local business administration.";
        ...
        reply += "You should take a look at the custom **Solo's Helios Elite** liquid-cooled desktop. Carrying an i9-14900K and an RTX 4080 Super, it is the absolute peak of processing power!";
